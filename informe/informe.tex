...
\begin{figure}[h]
    \centering
   \hfill\subcaptionbox{Imagen del \emph{dataset}
    utilizado.}{\includegraphics[scale=0.5]{../images/nonbin/05.png}}
   \hfill\subcaptionbox{Imagen del \emph{dataset}
    utilizado.}{\includegraphics[scale=0.5]{../images/bin/05.png}}
   \hfill\subcaptionbox{Imagen del \emph{dataset}
    utilizado.}{\includegraphics[scale=0.5]{../done0.5/05.png}}
   \hfill\subcaptionbox{Imagen del \emph{dataset}
    utilizado.}{\includegraphics[scale=0.5]{../done0.9/05.png}}
